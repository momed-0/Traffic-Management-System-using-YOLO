...
while True:
    ...
    for bbox in bus_tracker:
        x3,y3,x4,y4,bus_id=bbox
        cx=int(x3+x4)//2
        cy=int(y3+y4)//2
        # Draw the bounding box
        cv2.rectangle(frame,(x3,y3),(x4,y4) ,(0, 255, 0), 2)
        # Put the ID text above the bounding box
        cv2.putText(frame, f"{bus_id}: Bus", (x3, y3 - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
    ...
    for bbox1 in car_tracker:
        ...
        cv2.putText(frame,f"{id1}: Car",(x5,y5-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2)
    ...
    for bbox2 in auto_tracker:
        ...
        cv2.putText(frame,f"{id2}: Auto",(x7,y7-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2)
    ...
    for bbox3 in motor_tracker:
        ...
        cv2.putText(frame,f"{id3}: Bike",(x9,y9-10),cv2.FONT_HERSHEY_SIMPLEX,0.5,(0,255,0),2)
